            ...
            <div className="flex flex-col md:flex-row justify-between items-center md:items-start mt-8 space-y-6 md:space-y-0">
              ...
              <div className="text-center md:text-left">
                ...
                <ul className="flex justify-center md:justify-start space-x-5 mt-4">
                  ...
                  <li><a href="https://www.instagram.com/?next=%2F&hl=en" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><FaSquareInstagram size={28} className='text-pink-600 hover:text-pink-800 transition duration-300' /></a>
